...
<p align="center">
  <sub>npm: <a href="https://www.npmjs.com/package/@zseven-w/dsh-openpencil"><code>@zseven-w/dsh-openpencil</code></a> · 目前外掛程式發行版：<code>0.1.0-rc.1</code> · 已於 DSH <code>0.1.0-rc.6</code> 測試</sub>
</p>
