...
<p align="center">
  <sub>npm: <a href="https://www.npmjs.com/package/@zseven-w/dsh-openpencil"><code>@zseven-w/dsh-openpencil</code></a> · 現在のプラグインリリース: <code>0.1.0-rc.4</code> · DSH <code>0.1.1-rc.2</code> までテスト済み</sub>
</p>
